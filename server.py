...
class App(BaseHTTPRequestHandler):
    ...
    def ensure_marketing_compat(self, conn):
        """Keep marketing admin pages compatible with older marketing_bot.db schemas."""
        try:
            conn.execute("alter table facebook_targets add column exclude_keywords text default ''")
    ...
    def handle_marketing_state(self, platform):
        ...
        marketing = self.marketing()
        conn = marketing.db()
        self.ensure_marketing_compat(conn)
