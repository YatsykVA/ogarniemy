...
DB_PATH = os.environ.get("MARKETING_BOT_DB", os.path.join(ROOT, "marketing_bot.db"))
CONFIG_PATH = os.environ.get("MARKETING_BOT_CONFIG", os.path.join(ROOT, "marketing_bot_config.json"))
